...
## 2.	Make a new smart contract in src folder:
...
## 5. 	Create a backbone of the backend using solidity and test file.
...
## 6.	It allows sellers to post their request or products on the browser or portal.
...
## 7.	It allows buyers to check the product details and buy the products:
...
## 8.	Deploy smart contract on blockchain:
